...
# table(cut3(numbers,c(0,100,200),"breaks",c("low","high")))
...
#
#
# table(cut3(c(1,2,3),c(0,1,2.5,5),"breaks", crop = TRUE , closed="right", simplify = FALSE))
# table(cut3(c(1,2,3),c(0,1,2.5,5),"breaks", crop = FALSE, closed="right", simplify = FALSE))
#
#
